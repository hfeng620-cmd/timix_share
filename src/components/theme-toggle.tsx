              ...
              <button
                ...
                className={`rounded-[16px] border px-3 py-3 text-left transition ${
                  active
                    ...
                    : "border-[var(--color-line)] bg-[var(--color-panel-strong)] active:[border-color:var(--color-brand)] active:scale-[0.98] active:[background-color:var(--color-soft)] md:hover:[border-color:var(--color-brand)] md:hover:[background-color:var(--color-soft)]"
                }`}
