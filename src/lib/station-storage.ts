...
export async function seedDefaultStations(): Promise<number> {
  ...
  const defaults = [
    { name: "启元AI", badge: "低倍率", url: "https://ai.qystart.top", price: "充值 1:1 刀，约 110 元可用约 10 亿 tokens", multiplier: "0.055x", entry: "官网入口", packageType: "1:1 美元计价", status: "低倍率，待继续补稳定性样本", models: "主流模型待群补", verdict: "低成本优先观察", note: "倍率 0.055；充值 1:1 美元计价，人民币自己充值约 110 元，约可用 10 亿 tokens 左右。", advantage: "倍率和 tokens 成本口径都很低，适合放到前排重点比较。", risk: "仍需继续补高峰稳定性、模型覆盖和长期使用反馈。", groupName: "ai.qystart.top", sortOrder: 0 },
